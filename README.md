...
# Hi there, I'm Aminul Islam Efat! 👋
### 💻 CSE Student | Ethical Hacker | Cyber Security Researcher & Pentester

I am a passionate Computer Science and Engineering (CSE) student dedicated to the world of Cyber Security. I specialize in ethical hacking, penetration testing, and developing custom security/pentesting tools. I love exploring Linux environments, finding vulnerabilities, and building scripts to automate security workflows.

---

### 🚀 What I Do:
*   **Penetration Testing:** Assessing web applications, networks, and systems to find security loopholes.
*   **Tool Development:** Writing custom scripts and tools (Python/Bash/Go) to assist in ethical hacking and automation.
*   **Linux Power User:** Configuring, hardening, and leveraging Linux systems for advanced security tasks.
*   **Continuous Learning:** Constantly staying updated with the latest CVEs, exploits, and defensive strategies.
